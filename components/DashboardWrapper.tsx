            ...
            <div className="min-h-screen bg-[#FCF9F2] text-[#292e30] font-mono overflow-x-hidden selection:bg-[#292e30] selection:text-white">
                  <header className="border-b-2 border-[#292e30] p-4 flex justify-between items-center bg-[#292e30] text-white">
                          <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                                <h1 className="font-black italic tracking-tighter text-2xl leading-none">BLACKSTAR V2</h1>
                                                <p className="text-[9px] uppercase tracking-[0.2em] font-bold text-[#FFB000]">Geometric Frontrun Engine</p>
                                    </div>
                          </div>
                          <div className="flex gap-6 text-[10px] font-black uppercase">
                                    <div className="flex items-center gap-2">
                                                ...
                                                <span>MAINNET_ULTRA_SYNC</span>
                                    </div>
                                    <div className="text-right">
                                                <div className="opacity-50">Primary Signer</div>
                                                <div className="text-[#00FF00]">3KrLbAZE...uUQW</div>
                                    </div>
                          </div>
                  </header>
                  ...
                  <main className="p-6 max-w-[1400px] mx-auto grid grid-cols-12 gap-6">
                          ...
                          <div className="col-span-3 space-y-6">
                                    <div className="border-2 border-black p-4 bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                                                <div className="text-[10px] font-black opacity-30 mb-2 uppercase">Session PNL</div>
                                                <div className="text-4xl font-black italic tracking-tighter mb-4">+0.000</div>
                                                <div className="text-lg font-black text-[#00FF00] uppercase tracking-tighter">SOLANA (SOL)</div>
                                                <div className="mt-6 pt-6 border-t border-black/10 space-y-2 text-[10px] font-bold uppercase">
                                                               <div className="flex justify-between"><span>Avg Win</span><span className="text-black">+0.25 SOL</span></div>
                                                               <div className="flex justify-between"><span>Win Rate</span><span className="text-black">94.1%</span></div>
                                                </div>
